...
public final class JteindexGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,2,2,2,4,4,6,6,7,7,10,10,11,11,12,12,12,13,13,14,14,17,17,20,20,20,23,23,25,25,25,25,25,25,25,25,25,29,29,29,29,29,29,29,29,29,35,35,35,35,35,2,2,2,2};
		...
		gg.jte.generated.ondemand.layout.JtepageGenerated.render(jteOutput, jteHtmlInterceptor, new gg.jte.html.HtmlContent() {
			public void writeTo(gg.jte.html.HtmlTemplateOutput jteOutput) {
				...
				if (page.getValidationErrors() != null) {
					...
					jteOutput.writeContent("\r\n                </ul>\r\n            </div>\r\n            ");
				} else if (page.getErrors() != null) {
					jteOutput.writeContent("\r\n                <div class=\"mb-3\">\r\n                    <ul>\r\n                        <li>");
					jteOutput.setContext("li", null);
					jteOutput.writeUserContent(page.getErrors());
					jteOutput.writeContent("</li>\r\n                    </ul>\r\n                </div>\r\n        ");
				}
